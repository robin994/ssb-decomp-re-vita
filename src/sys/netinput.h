...
extern void syNetInputModernSetMaxPrediction(s32 frames);
extern s32 syNetInputModernGetMaxPrediction(void);
extern u32 syNetInputModernGetPredictedFrameCount(void);
