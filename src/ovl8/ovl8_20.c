...
void func_ovl8_8038295C();
void func_ovl8_80382A20();
void func_ovl8_80382A80();
void func_ovl8_80382AA0(dbUnknown5*, f32);

dbFunction D_ovl8_8038C1C0[] = {
	{0, NULL},
	{0, (sb32(*)())(func_ovl8_8038295C)},
	{0, (sb32(*)())(func_ovl8_80382A20)},
	{0, func_ovl8_8037C9E4},
	{0, func_ovl8_80373650},
	{0, func_ovl8_8037367C},
	{0, func_ovl8_80373684},
	{0, func_ovl8_8037368C},
	{0, (sb32(*)())(func_ovl8_80382AA0)},
	{0, func_ovl8_80373750},
	{0, func_ovl8_80373790},
	{0, func_ovl8_803737DC},
	{0, (sb32(*)())(func_ovl8_80382A80)},
...
dbFunction D_ovl8_8038C2A0[] = {
	{0, NULL},
	{(s16)0xFF1C, (sb32(*)())(func_ovl8_8038295C)},
	...
	{(s16)0xFF1C, func_ovl8_80373650},
	{0, func_ovl8_80371C2C},
	{(s16)0xFF5C, func_ovl8_80372224},
	{0, func_ovl8_80371C8C},
	{(s16)0xFF5C, func_ovl8_80372358},
	{(s16)0xFF1C, (sb32(*)())(func_ovl8_80382A20)},
...
dbFunction D_ovl8_8038C3F8[] = {
	{0, NULL},
	{(s16)0xFF28, (sb32(*)())(func_ovl8_8038295C)},
	{0, func_ovl8_8037C344},
	{0, func_ovl8_8037C358},
	{0, NULL},
};

dbFunction D_ovl8_8038C420[] = {
	{0, NULL},
	{(s16)0xFFC0, (sb32(*)())(func_ovl8_8038295C)},
...
dbFunction D_ovl8_8038C488[] = {
	{0, NULL},
	{(s16)0xFF48, (sb32(*)())(func_ovl8_8038295C)},
...
dbUnknown5* func_ovl8_80382870(dbUnknown5* arg0, dbUnknownLinkStruct* arg1, dbUnknownLink* arg2, dbUnknown3* arg3, s32 arg4, s32 arg5, s32 arg6);
...
// 80382710
#endif
dbUnknown5* func_ovl8_80382710(s32 arg0, DBMenu* arg1) {
#ifdef PORT
...
#ifdef PORT
    if (arg1->unk_dbmenu_0x10 == 2) {
        sp2C = 2;
    } else if (arg1->unk_dbmenu_0x10 == 5) {
        sp2C = 3;
    }
    temp_v0_2 = func_ovl8_803717A0(0x140);
    
    if (temp_v0_2) {
        sp34 = temp_v0_2;
        func_ovl8_80382870(temp_v0_2, NULL, NULL, arg1, sp2C, arg1->unk_dbmenu_0x24, arg0);
        var_v1 = sp34;
    } else {
        var_v1 = NULL;
    }
...
// 803827A8
#endif
dbUnknown5* func_ovl8_803827A8(dbUnknown5* arg0, dbUnknownLinkStruct* arg1, dbUnknownLink* arg2)
{
#ifdef PORT
